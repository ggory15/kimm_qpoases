...
CMakeFiles/dist_targz:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/ggory15/git/kimm_qpoases/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating tar.gz tarball and its signature..."
	/usr/bin/tar -czf kimm_qpoases-1.0.0.tar.gz kimm_qpoases-1.0.0/ && /usr/bin/gpg --detach-sign --armor -o /home/ggory15/git/kimm_qpoases/build/kimm_qpoases-1.0.0.tar.gz.sig /home/ggory15/git/kimm_qpoases/build/kimm_qpoases-1.0.0.tar.gz
