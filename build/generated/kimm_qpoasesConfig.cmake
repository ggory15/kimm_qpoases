...
if(NOT kimm_qpoases_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${kimm_qpoases_FIND_COMPONENTS})
    if(NOT "kimm_qpoases_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("kimm_qpoases_INCLUDE_DIRS" "/opt/openrobots/include")
set("KIMM_QPOASES_INCLUDE_DIRS" "/opt/openrobots/include")
set("kimm_qpoases_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/kimm_qpoases/doxygen-html")
set("KIMM_QPOASES_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/kimm_qpoases/doxygen-html")
set("kimm_qpoases_DEPENDENCIES" "")
set("kimm_qpoases_PKG_CONFIG_DEPENDENCIES" "")
...
set("kimm_qpoases_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("KIMM_QPOASES_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${kimm_qpoases_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/kimm_qpoasesTargets.cmake")
...
foreach(component ${kimm_qpoases_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(kimm_qpoases_${component}_FOUND FALSE)
  endif()
  if(kimm_qpoases_${component}_FOUND)
    message(STATUS "kimm_qpoases: ${component} found.")
  else()
    message(STATUS "kimm_qpoases: ${component} not found.")
  endif()
endforeach()
check_required_components("kimm_qpoases")
