...
#ifndef KIMM_QPOASES_DEPRECATED_HH
# define KIMM_QPOASES_DEPRECATED_HH
...
//  void foo () KIMM_QPOASES_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar KIMM_QPOASES_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a KIMM_QPOASES_DEPRECATED = 0;
//
...
#  define KIMM_QPOASES_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define KIMM_QPOASES_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define KIMM_QPOASES_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! KIMM_QPOASES_DEPRECATED_HH
